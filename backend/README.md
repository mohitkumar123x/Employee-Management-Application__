...
cd Employee-Management-Application/backend
```

### 2. Install Dependencies

Ensure you have [Gradle](https://gradle.org/) and [Java JDK](https://www.oracle.com/java/technologies/javase-jdk11-downloads.html) installed. Run the following command to install the required dependencies:
...
- **`Build failed`**: If the Gradle build fails, check if you are using Java 11 and have the necessary dependencies installed. Also, check the error logs for more details.
